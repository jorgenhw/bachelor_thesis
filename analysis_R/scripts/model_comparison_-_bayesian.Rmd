...
sample_a_bar <- rnorm(1e4, 0, 0.2)
sample_sigma_model <- rexp(1e4, 10)
sample_a_model <- rnorm(1e4, sample_a_bar, sample_sigma_model)
sample_sigma_group <- rexp(1e4, 10)
sample_a_group <- rnorm(1e4, 0, sample_sigma_group)
sample_mu <- sample_a_model + sample_a_group
sample_sigma <- rexp(1e4, 10)
prior_diff_topic <- rnorm(1e4, sample_mu, sample_sigma)

dens(prior_diff_topic)
```
...
sample_sigma_group <- rexp(1e4, 10)
sample_a_group <- rnorm(1e4, 0, sample_sigma_group)
sample_sigma_type <- rexp(1e4, 10)
sample_a_type <- rnorm(1e4, 0, sample_sigma_type)
sample_mu <- sample_a_model + sample_a_group + sample_a_type
sample_sigma <- rexp(1e4, 10)
prior_diff_topic <- rnorm(1e4, sample_mu, sample_sigma)
...
sample_sigma_type <- rexp(1e4, 10)
sample_a_type <- rnorm(1e4, 0, sample_sigma_type)
sample_mu <- sample_a_model + sample_a_type
sample_sigma <- rexp(1e4, 10)
prior_diff_topic <- rnorm(1e4, sample_mu, sample_sigma)
